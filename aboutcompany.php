...
<body>
  ...
  <main>
    <img class="backgroundcompany" src="img/backgroundcompany.png" alt="backgroundimagecompany">
    <div class="heading">
      <h1>Эксклюзивный российский и зарубежный контент</h1>
    </div>
    <ul class="movie">
      <li class="movie_li">
        <div class="movie-item"><img src="img/img_comp1.jpg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/img_comp2.jpg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/img_comp3.jpg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/img_comp4.jpg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/img_comp5.jpg" alt="product"></div>
      </li>
    </ul>
    <div class="heading">
      <h1>Более 300 контентных партнёров.</h1>
    </div>
    <ul class="movie">
      <li class="movie_li">
        <div class="movie-item"><img src="img/universal.svg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/disney.svg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/viacom.svg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/bbc.svg" alt="product"></div>
      </li>
      <li class="movie_li">
        <div class="movie-item"><img src="img/marvel.svg" alt="product"></div>
      </li>
    </ul>
    <div class="heading">
      <h1>В Amtor работает большая, дружная команда, в которой уже более 100 талантливых специалистов. Присоединяйтесь!</h1>
    </div>
    <img class="bckgr_company" src="img/backgroundcompany2.jpg" alt="backgroundimagecompany" width="800">
  </main>
