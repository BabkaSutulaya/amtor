...
<body>
  ...
  <main>
    ...
    <ul class="movie">
      <li class="movie_li">
        <div class="movie-item">
          <img src="img/promo_img1.jpg" alt="product">
          <div class="product-list">
            <h3><a href="https://yandex.ru/">Голоса известных героев в навигаторе 2ГИС</a></h3>
            <span class="description">Без ограничений по времени</span>
          </div>
        </div>
      </li>
      <li class="movie_li">
        <div class="movie-item">
          <img src="img/promo_img2.jpg" alt="product">
          <div class="product-list">
            <h3><a href="https://yandex.ru/">Смотрите с бонусами программы «СберСпасибо»</a></h3>
            <span class="description">Без ограничений по времени</span>
          </div>
        </div>
      </li>
    ...
    <div class="heading">
      <h1>Если у вас есть вопросы, идеи, предложения о сотрудничестве и пожелания напишите нам на почту: partnerAmtor@yandex.ru</h1>
    </div>
